...
void* TCMallocAllocator::reallocate(void* old, size_t size, const char* file, long line)
{
	void* p = tc_realloc(old, size);
...
void* TCMallocAllocator::reallocate(void* old, size_t size)
{
	return tc_realloc(old, size);
}
